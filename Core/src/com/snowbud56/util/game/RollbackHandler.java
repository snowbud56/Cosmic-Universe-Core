...
public class RollbackHandler {
    ...
    public void rollback(String gameName, String mapName) {
        ...
        Bukkit.unloadWorld(Bukkit.getWorld("main_active"), false);
        String rootDirectory = Core.getPlugin().getServer().getWorldContainer().getAbsolutePath();
        File srcFolder = new File(rootDirectory + "/maps/" + gameName + "/" + mapName);
